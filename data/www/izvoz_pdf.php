...
// --- 2. SEKCIJA: POVPRASŠEVANJA ---
// Če je tabela predolga, tFPDF sam doda novo stran
$pdf->SetFont('DejaVu', 'B', 13);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(0, 10, '2. Zgodovina povpraševanj po posvojitvi', 0, 1, 'L');
$pdf->Ln(2);
